...
player_mapping1(".ogg") -> {ok, ["/usr/bin/env", "cvlc", url]};
player_mapping1(".mp3") -> {ok, ["/usr/bin/env", "cvlc", url]};
player_mapping1(".m4a") -> {ok, ["/usr/bin/env", "cvlc", url]};
player_mapping1(".wav") -> {ok, ["/usr/bin/env", "cvlc", url]};
player_mapping1(".flac") -> {ok, ["/usr/bin/env", "cvlc", url]};
